...
<div class="modal fade" id="eliminarOrden{{$po->id_ordencompra}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="row row-cols-auto">
                    <div class="col">
                        <form action="/proveedores/ticket/item/{{$po->id_ordencompra}}/delete" method="POST">
                            @csrf
                            @method('DELETE')
