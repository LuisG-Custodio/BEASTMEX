...
<div class="modal fade" id="editarProducto{{$i->id_producto}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Guardar Producto</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="/productos/{{$i->id_producto}}/update" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="inputNombreProducto" class="form-label">Nombre del Producto</label>
                            <input type="text" class="form-control" id="inputNombreProducto" name="_NombreProducto" value="{{$i->Nombre}}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="inputNumeroSerie" name="_NumeroSerie" value="{{$i->No_Serie}}">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="inputMarca" name="_Marca" value="{{$i->Marca}}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="inputCosto" name="_Costo" value="{{number_format($i->Costo_compra, 2) }}">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="inputStock" name="_Stock" value="{{$i->Stock}}">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="_NombreProveedor" id="inputStock">
                                ...
                                <option value="{{$p->id_proveedor}}" @if ($p->id_proveedor == $i->id_proveedor) selected @endif>{{$p->Nombre}} {{$p->AP}} {{$p->AM}}</option>
                                @endforeach
                            </select>
...
<div class="modal fade" id="eliminarProducto{{$i->id_producto}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <p>¿Está seguro de que desea eliminar el producto {{$i->Nombre}}?</p>
            </div>
            <div class="modal-footer">
                <div class="row row-cols-auto">
                    <div class="col">
                        <form action="/productos/{{$i->id_producto}}/delete" method="POST">
                            @csrf
                            @method('DELETE')
